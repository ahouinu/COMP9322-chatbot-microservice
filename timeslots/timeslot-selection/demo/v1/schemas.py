...
validators = {
    ('timeslots_id_reserve', 'GET'): {'headers': {'required': ['Authorization'], 'properties': {'Authorization': {'type': 'string', 'description': 'JWT of the patient'}}}, 'args': {'required': ['doc_id'], 'properties': {'doc_id': {'type': 'integer', 'minimum': 0, 'description': 'ID of the dentist'}}}},
...
filters = {
    ('timeslots', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'message': {'type': 'string', 'description': 'message from server'}, 'timeslots': {'type': 'array', 'items': {'$ref': '#/definitions/Timeslot'}, 'description': 'array of all timeslots'}}}}},
    ('timeslots_id_reserve', 'GET'): {200: {'headers': None, 'schema': {'type': 'object', 'properties': {'message': {'type': 'string', 'example': 'Booked successfully', 'description': 'message from server'}, 'timeslot': {'$ref': '#/definitions/Timeslot'}}}}, 400: {'headers': None, 'schema': {'type': 'object', 'properties': {'message': {'type': 'string', 'description': 'The timeslot you tried to book is currently unavailable.'}}}}, 404: {'headers': None, 'schema': {'type': 'object', 'properties': {'message': {'type': 'string', 'description': "The timeslot you tried to book couldn't be found on the server."}}}}},
